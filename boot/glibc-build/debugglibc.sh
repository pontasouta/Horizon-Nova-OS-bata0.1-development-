...
SOURCE_DIR="/home/sota/myos/boot/lib/glibc"
BUILD_DIR="/home/sota/myos/boot/glibc-build/"
CMD_FILE="/home/sota/myos/boot/glibc-build/debugglibc.gdb"
CONTAINER=false
DIRECT=true
STATIC=false
SYMBOLSFILE=true
...
run --library-path /home/sota/myos/boot/glibc-build:/home/sota/myos/boot/glibc-build/math:/home/sota/myos/boot/glibc-build/elf:/home/sota/myos/boot/glibc-build/dlfcn:/home/sota/myos/boot/glibc-build/nss:/home/sota/myos/boot/glibc-build/nis:/home/sota/myos/boot/glibc-build/rt:/home/sota/myos/boot/glibc-build/resolv:/home/sota/myos/boot/glibc-build/mathvec:/home/sota/myos/boot/glibc-build/support:/home/sota/myos/boot/glibc-build/misc:/home/sota/myos/boot/glibc-build/debug:/home/sota/myos/boot/glibc-build/nptl:/usr/lib/gcc/x86_64-pc-linux-gnu/16.1.1/../../../../lib/:${BUILD_DIR}/nptl_db __COMMANDLINE__ __DIRECT__
__BREAKPOINTS__
EOF
}
...
WAIT_FOR_DEBUGGER=1 /home/sota/myos/boot/glibc-build/testrun.sh --tool=container ${TESTCASE} &
gdb -x ${TESTCASE}.gdb
elif [ "$STATIC" == true ]
then
gdb ${TESTCASE}
